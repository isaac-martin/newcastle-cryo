...
$msg_first_name = $dataSnd['firstName'];
$msg_last_name = $dataSnd['lastName'];
$msg_booking_enquiry =  $dataSnd['enquiry'];
  ...
  $template .='<ul style="font-family: sans-serif; font-size: 16px !important; font-weight: normal; color: #424141; margin: 0 0 15px; padding: 0; list-style:none;"><li style="list-style-type: none; margin-left: 5px; padding: 0;">'.$msg_first_name. '&nbsp;' .$msg_last_name.'</li><li style="list-style-type: none; margin-left: 5px; padding: 0;">'.$msg_phone.' <br /> '.$msg_email.'</li><li style="list-style-type: none; margin-left: 5px; padding: 0;">'.$msg_booking_enquiry.'</li></ul></p><table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;"><tbody><tr><td align="left" style="font-family: sans-serif; font-size: 16px !important; vertical-align: top; padding-bottom: 15px;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100% !important;"><tbody><tr><td style="font-family: sans-serif; font-size: 16px !important; vertical-align: top; border-radius: 5px; text-align: center; background-color: #424141;" align="center" bgcolor="#8942B2" valign="top"> <a style="color: #ffffff!important; text-decoration: none!important; font-family: sans-serif; text-transform: capitalise; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px !important; font-weight: bold; width: 100% !important; background-color: #007bc5; margin: 0; padding: 12px 25px; border: 1px solid #007bc5;" href="mailto:'.$msg_email.'" target="_blank" >Reply To Request</a> </td></tr></tbody></table></td></tr></tbody></table></td></tr></table></td></tr></table></div></td><td style="font-family: sans-serif; font-size: 16px !important; vertical-align: top;" valign="top"> </td></tr></table></body></html>';
  // echo $template;
